...
public class HeartbeatHandler : MonoBehaviour
{
    ...
    [SerializeField] private TMP_Text fingerText;
    ...
    void FixedUpdate()
    {
        ...
        //{
        //    pressureText.text = gloveHandler.haptics.pressureData[0] + "\n" +
        //                        gloveHandler.haptics.pressureData[1] + "\n" +
        //                        gloveHandler.haptics.pressureData[2] + "\n" +
        //                        gloveHandler.haptics.pressureData[3] + "\n" +
        //                        gloveHandler.haptics.pressureData[4] + "\n" +
        //                        gloveHandler.haptics.pressureData[5];
        //}
