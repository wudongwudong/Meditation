...
public class PhysicsHandTracking : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        targetJoints[0] = handRoot.Find(hand + "_wrist/" + hand + "_thumb_metacarpal");
        targetJoints[1] = targetJoints[0].GetChild(0);
        targetJoints[2] = targetJoints[1].GetChild(0);
        targetJoints[3] = targetJoints[2].GetChild(0);

        targetJoints[4] = handRoot.Find(hand + "_wrist/" + hand + "_index_metacarpal");
        ...
        targetJoints[9] = handRoot.Find(hand + "_wrist/" + hand + "_middle_metacarpal");
        ...
        targetJoints[14] = handRoot.Find(hand + "_wrist/" + hand + "_ring_metacarpal");
        ...
        targetJoints[19] = handRoot.Find(hand + "_wrist/" + hand + "_little_metacarpal");
        ...
        targetJoints[24] = handRoot.Find(hand + "_wrist/" + hand + "_palm");
        targetJoints[25] = handRoot.Find(hand + "_wrist/");
